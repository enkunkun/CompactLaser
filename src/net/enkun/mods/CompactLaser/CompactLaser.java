...
@Mod(name = "CompactLaser", version = "0.4.1", useMetadata = false, modid = "CompactLaser", dependencies = "required-after:BuildCraft|Core;required-after:BuildCraft|Silicon;required-after:BuildCraft|Transport")
...
public class CompactLaser {
	...
	public void load(FMLInitializationEvent evt) {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(BuildCraftSilicon.laserBlock, 8), 
				new ItemStack(CompactLaserBlock));
	}
